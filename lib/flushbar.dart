...
/// [clickAction] Action to be performed while tap on Flushbar, right after animation will finish. Will be ignored for InputFlushbar.
    ...
    return GestureDetector(
      onTap: () {
        if (widget.clickAction != null) {
          widget.dismiss();
          Future.delayed(widget.animationDuration, widget.clickAction);
        }
      },
      child: DecoratedBox(
