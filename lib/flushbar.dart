...
class _FlushbarRoute<T> extends OverlayRoute<T> {
            ...
            final Widget annotatedChild = Semantics(
              child: AlignTransition(
                ...
                child: flushbar.isDismissible
                    ? _getDismissibleFlushbar(_builder, flushbar.dismissDirection)
                    : _builder,
              ),
              focused: true,
              scopesRoute: true,
  ...
  Animation<Alignment> createAnimation() {
    ...
    return AlignmentTween(begin: _initialAlignment, end: _endAlignment).animate(CurvedAnimation(
        parent: _controller,
  ...
  // final FlushbarProxyAnimation _secondaryAnimation = FlushbarProxyAnimation(kAlwaysDismissedAnimation);
...
/// [left] An optional widget to display as the left side content of the flushbar, to handle more customized content than provided by [Icon].
...
/// [onPressed] Action to be performed while tap on Flushbar, right after animation will finish. Will be ignored for InputFlushbar.
/// [showDuration] How long until Flushbar will hide itself (be dismissed). To make it indefinite, leave it null.
/// [shadowColor] The shadow generated by the Flushbar. Leave it null if you don't want a shadow.
/// [animationDuration] Show/hide animation duration in seconds. By default duration is 1 second
/// [isDismissible] Determines if the user can swipe to dismiss the bar. It is recommended that you set [showDuration] != null if [isDismissible] == false. If the user swipes Flushbar to dismiss it no value will be returned.
...
class _FlushbarState<K extends Object> extends State<Flushbar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    assert(
        ((widget.userInputForm != null || (widget.message != null || widget.messageText != null))),
  ...
  void _configurePulseAnimation() {
    _fadeController = AnimationController(vsync: this, duration: widget.animationDuration);
    ...
    return GestureDetector(
      onTap: () {
        if (widget.onPressed != null) {
          widget.dismiss();
          Future.delayed(widget.animationDuration, widget.onPressed);
        }
      },
      child: DecoratedBox(
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: _messageTopMargin, left: 16.0, right: 16.0, bottom: 16.0),
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: _messageTopMargin, left: 4.0, right: 16.0, bottom: 16.0),
                child: widget.messageText ?? _getDefaultNotificationText(),
              ),
            ],
          ),
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: _messageTopMargin, left: 16.0, right: 8.0, bottom: 16.0),
                child: widget.messageText ?? _getDefaultNotificationText(),
              ),
            ],
          ),
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: _messageTopMargin, left: 4.0, right: 8.0, bottom: 16.0),
                child: widget.messageText ?? _getDefaultNotificationText(),
              ),
            ],
          ),
